...
\moditem{*} \named{Точка Микеля четырехсторонника}{На плоскости даны четыре прямые общего положения. Эти прямые образуют $4$ треугольника. Докажите, что описанные окружности этих треугольников пересекаются в одной точке.}  \label{th:miquel's point}
    ...
    \solution{
        % TODO: Эту лемму нужно в сложные уголки
